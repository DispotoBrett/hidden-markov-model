...
def test_manually():
    ...
    with open('preprocessed_families.txt', 'r') as file:
        ...
        for family in families:
            ...
            os.system('{0}\\svm-train.exe -c {1} -g {2} {3} {4}/train.model > junk'.format(exe_dir, 2, 2 ** -14, training_file, family))
            os.system('{0}\\svm-predict.exe {1} {2}/train.model {2}/test.predict'.format(exe_dir, testing_file, family))
